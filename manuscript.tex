...
\begin{figure}
  ...
  \caption{Basically a placeholder -- we still need to decide exactly what to put in here and how to measure success.}\label{languageComparison}
\end{figure}
...
Universal Grammar: innate for child language learners and discovered
empirically by linguists.
In practice,
