...
\bottomrule\end{longtable}
\begin{tabular}{l}\emph{Rules: }\\
\phonr{[ -sonorant ]}{[ -voice ]}{[ -voice ]}\\\phonr{\textipa{e}}{V\textsubscript{i}}{[ -liquid ] V\textsubscript{i}}\\\phonb{C}{$\varnothing$}{[ +coronal ]}{\#}\\\phonr{[ -sonorant ]}{\textipa{s}}{\#}\\\phonb{$\varnothing$}{\textipa{e}}{[ -sonorant ]}{[ +voice ] \#}\\\phonb{$\varnothing$}{[ -voice ]\textsubscript{i}}{[ +sibilant ]}{V [ -voice ]\textsubscript{i}}\\\phonb{$\varnothing$}{[ +voice ]\textsubscript{i}}{\# [ -coronal ] [ -high ]}{[ +voice ]\textsubscript{i} \textipa{i}}
\end{tabular}
\begin{tabular}{l}\emph{Textbook solution rules: }\\
